...
export const metadata: Metadata = {
	...
	description:
		'Explore the public OpenAPI specification, schemas, examples, and send real API requests.'
};
		...
		<main className={styles.page}>
			<header className={styles.heading}>
				<div>
					<h1>API reference</h1>
					<p>
						Filter a section by name (for example, Analytics), inspect an
						operation and its schema, and select Try it out and Execute to call
						the public API.
					</p>
				</div>
