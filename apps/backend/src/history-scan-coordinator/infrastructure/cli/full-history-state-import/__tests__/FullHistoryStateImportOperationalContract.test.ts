...
describe('full-history state-import operational contract', () => {
	it('starts four loops and emits exact JSON lifecycle events by default', async () => {
		...
		expect(stdout).toEqual([
			'{"databasePoolSize":6,"event":"runtime","exportTimeoutMs":10800000,"insertRows":100,"leaseMs":600000,"status":"ready","storageRoot":"/home/observe/stellarbeat-data/full-history/typed","workers":4}\n',
