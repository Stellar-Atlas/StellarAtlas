import { sourceStatusSummarySql } from './HistoryArchiveSourceStatusSql.js';
export { sourceStatusSummarySql } from './HistoryArchiveSourceStatusSql.js';
import { attachArchiveScanCoverage } from './HistoryArchiveScanCoverageReadModel.js';
import { attachArchiveFailureSummaries } from './KnownArchiveFailureSummarySnapshot.js';
...
async function getStatusSourceSummaries(
	...
	return attachArchiveFailureSummaries(manager, sources);
}
