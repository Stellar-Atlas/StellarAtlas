...
import { GetKnownNode } from '../../use-cases/get-known-node/GetKnownNode.js';
import { GetKnownNodes } from '../../use-cases/get-known-nodes/GetKnownNodes.js';
import { GetKnownOrganization } from '../../use-cases/get-known-organization/GetKnownOrganization.js';
...
function loadUseCases(container: Container) {
	...
	container.bind(GetKnownNode).toSelf();
	container.bind(GetKnownNodes).toSelf();
	container.bind(GetKnownOrganization).toSelf();
