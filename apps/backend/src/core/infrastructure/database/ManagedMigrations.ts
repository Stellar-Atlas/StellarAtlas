...
import { HistoryArchiveFrontierCandidateIndexMigration1785250000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785250000000-HistoryArchiveFrontierCandidateIndexMigration.js';
import { FullHistoryZeroTransactionProofPromotionMigration1785260000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785260000000-FullHistoryZeroTransactionProofPromotionMigration.js';
import { HistoryArchiveReadyQueueMigration1785270000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785270000000-HistoryArchiveReadyQueueMigration.js';
...
import { HistoryArchiveWriteAmplificationMigration1785330000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785330000000-HistoryArchiveWriteAmplificationMigration.js';
import { HistoryArchiveClaimLeaseMigration1785340000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785340000000-HistoryArchiveClaimLeaseMigration.js';
...
import { HistoryArchiveContentReuseMigration1785520000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785520000000-HistoryArchiveContentReuseMigration.js';
import { HistoryArchiveCompactPlanningMigration1785530000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785530000000-HistoryArchiveCompactPlanningMigration.js';
import { HistoryArchiveSequentialProofChainMigration1785540000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785540000000-HistoryArchiveSequentialProofChainMigration.js';
import { HistoryArchiveObjectReferenceIndexesMigration1785550000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785550000000-HistoryArchiveObjectReferenceIndexesMigration.js';
import { HistoryArchiveReadyParallelismMigration1785560000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785560000000-HistoryArchiveReadyParallelismMigration.js';
import { HistoryArchiveUnusedHostStatusIndexMigration1785570000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785570000000-HistoryArchiveUnusedHostStatusIndexMigration.js';
import { HistoryArchiveCheckpointProofStatementRollupMigration1785580000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785580000000-HistoryArchiveCheckpointProofStatementRollupMigration.js';
import { HistoryArchiveCheckpointProofStatementRollupCorrectionMigration1785590000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785590000000-HistoryArchiveCheckpointProofStatementRollupCorrectionMigration.js';
import { FullHistoryLedgerTwoBootstrapMigration1785600000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785600000000-FullHistoryLedgerTwoBootstrapMigration.js';
import { ParsedTransactionMaintenanceMigration1785610000000 } from '@history-scan-coordinator/infrastructure/database/migrations/1785610000000-ParsedTransactionMaintenanceMigration.js';
...
export const managedMigrations = [
	...
	HistoryArchiveFrontierCandidateIndexMigration1785250000000,
	...
	HistoryArchiveWriteAmplificationMigration1785330000000,
	...
	HistoryArchiveContentReuseMigration1785520000000,
	HistoryArchiveCompactPlanningMigration1785530000000,
	HistoryArchiveSequentialProofChainMigration1785540000000,
	HistoryArchiveObjectReferenceIndexesMigration1785550000000,
	HistoryArchiveReadyParallelismMigration1785560000000,
	HistoryArchiveUnusedHostStatusIndexMigration1785570000000,
	...
	FullHistoryLedgerTwoBootstrapMigration1785600000000,
