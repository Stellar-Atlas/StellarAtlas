module github.com/stellar/stellar-etl/v2/stellaratlas-hubble
...
require (
	...
	github.com/Stellar-Atlas/StellarAtlas/apps/full-history-etl v0.0.0
...
replace github.com/Stellar-Atlas/StellarAtlas/apps/full-history-etl => ../full-history-etl
